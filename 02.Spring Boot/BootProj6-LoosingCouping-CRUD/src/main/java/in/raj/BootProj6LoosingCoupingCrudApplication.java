...
public class BootProj6LoosingCoupingCrudApplication {
    ...
    public static void main(String[] args) {
        ConfigurableApplicationContext ctx = SpringApplication.run(BootProj6LoosingCoupingCrudApplication.class, args);//get Controller class obj
        EmployController controller = ctx.getBean(EmployController.class);
